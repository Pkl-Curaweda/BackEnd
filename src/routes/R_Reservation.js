...
const {
  ...
  getFilterRoomAvail,
  getRoomAvailability,
} = require("../controllers/Reservation/C_RoomAvailability");
const { getAllReport } = require("../controllers/Reservation/C_Report");
const {
  getInvoice,
  testInvoice,
  getSummary,
} = require("../controllers/Reservation/C_Invoice");
const {
  getHelperDetail,
  postHelperDetail,
  ...
  getReportDetail,
  getInvoiceDetail,
} = require("../controllers/Reservation/C_Detail");
...
//?DETAIL RESERVATION
R_Reservation.get(
  "/detail/reservation/:reservationId/:resvRoomId/:action?",
  getHelperDetail
);
R_Reservation.get("/detail/report/:displayOption?", getReportDetail);
R_Reservation.get(
  "/detail/invoice/:reservationId/:resvRoomId/:date",
  getInvoiceDetail
);
R_Reservation.post(
  "/detail/reservation/:reservationId/:resvRoomId/:action/:changeProgress?",
  postHelperDetail
);
R_Reservation.put(
  "/detail/reservation/:reservationId/:resvRoomId/edit",
  putNewReservationData
);
R_Reservation.delete(
  "/detail/reservation/:reservationId/:resvRoomId/delete",
  deleteReservation
);
...
//? PRINT INVOICE
R_Reservation.get("/invoice/print", generatePDF);
